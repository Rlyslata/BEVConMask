...
class MaskClipHead(nn.Module):
    ...
    def __init__(self,
                 text_embeddings_path='/opt/data/private/CSBEV/pretrained_model/MaskCLIP/nuscenes_ViT16_clip_text.pth',
                 visual_projs_path='/opt/data/private/CSBEV/pretrained_model/MaskCLIP/ViT16_clip_weights.pth',
                 channels=0,
                 num_classes=16,
                 in_channels=768,
                 dropout_ratio=0,
...
class maskClipFeatureExtractor(nn.Module):
    ...
    def __init__(self,
        ...
        self.decoder = MaskClipHead(text_embeddings_path=config.DATASET.TEXT_EMBEDDINGS_PATH,
                                    visual_projs_path=config.IMAGE_ENCODER.VISUAL_PROJS_PATH,
        ...
        self.checkpoint = config.IMAGE_ENCODER.CHECKPOINT
