...
class WaymoDownstreamDataset(DatasetTemplate):
...
def create_waymo_infos(dataset_cfg, class_names, data_path, save_path,
    ...
    dataset = WaymoDownstreamDataset(
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', type=str, default='/opt/data/private/dataset/OpenDataLab___Waymo/waymo', help='')
